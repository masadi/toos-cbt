...
<div class="c-sidebar-brand">
    <a href="{{url('/')}}">
        <img class="c-sidebar-brand-full" src="{{ asset('assets/img/logo.png') }}" width="89" height="25" alt="TOOS">
        <img class="c-sidebar-brand-minimized" src="{{ asset('assets/brand/coreui-signet-white.svg') }}" width="30" height="30" alt="TOOS">
    </a>
</div>
<ul class="c-sidebar-nav">
    ...
    @endif
    <li class="c-sidebar-nav-item">
        <a class="c-sidebar-nav-link" href="/signout">
            <i class="cil-account-logout c-sidebar-nav-icon"></i>
            <!--svg class="c-icon mr-2">
                <use xlink:href="{{ env('APP_URL') }}/assets/icons/coreui/free-symbol-defs.svg#cui-account-logout">
                </use>
            </svg--> <span class="text-danger">Logout</span>
        </a>
    </li>
</ul>
