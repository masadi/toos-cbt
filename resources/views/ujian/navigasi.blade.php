...
<div class="row clearfix">
    <?php if ($prev >= 0): ?>
        <a class="navigasi btn btn-lg btn-primary float-left" href="{{route('ujian.get_soal', ['page' => $prev,'soal_id' => $keys[$prev]])}}">Previous</a>
    <?php endif; ?>
    ...
    @if ($next < $count)
        <a class="navigasi btn btn-lg btn-primary float-right" href="{{route('ujian.get_soal', ['page' => $next,'soal_id' => $keys[$next]])}}">Next</a>
    @else
