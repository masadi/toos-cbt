                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header-actions">
                            <a class="btn btn-sm btn-success"
                                href="{{route('referensi.tambah_data', ['query' => 'rombongan-belajar'])}}">Tambah Data</a>
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    function init() {
        table = $('#datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{route('ajax.get_all_data', ['query' => 'rombongan-belajar'])}}',
            ...
            columns: [
                ...
                { data: 'nama', name: 'nama' },
                { data: 'tingkat_pendidikan_id', name: 'tingkat_pendidikan_id' },
                @role('admin')
                { data: 'sekolah', name: 'sekolah' },
                @endrole
                { data: 'anggota', name: 'anggota', orderable: false, searchable: false },
                { data: 'pembelajaran', name: 'pembelajaran', orderable: false, searchable: false },
